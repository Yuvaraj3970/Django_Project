...
def user_directory(instance, filename):
    # this file will be uploaded to MEDIA_ROOT with name /user(user_id)/filename
...
class Post(models.Model):
    ...
    picture = models.ImageField(upload_to=user_directory, verbose_name='Picture', null=False)
